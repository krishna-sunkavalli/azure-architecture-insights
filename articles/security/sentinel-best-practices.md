...
|---|---|
| [Data Collection and Connectors](#data-collection-and-connectors) | Connector sequencing, DCR filtering, Logstash penalties, workspace scope, CEF/Syslog forwarder sizing |
| [Data Tiers, Retention, and Cost](#data-tiers-retention-and-cost) | Analytics vs lake tier placement, retention windows, federation, summarization, commitment tiers |
| [Detection Engineering](#detection-engineering) | Rule hygiene, ASIM normalization, NRT rules, use case mapping, DCR transformations |
| [Identity, UEBA, and Enrichment](#identity-ueba-and-enrichment) | UEBA enablement, watchlist design |
| [KQL and Threat Hunting](#kql-and-threat-hunting) | Query optimization, identity graph traversal, notebook use case boundary, MSTICPy, AML compute sizing |
| [SOC Operations](#soc-operations) | Incident workflow, RBAC, multi-workspace decisions, Defender portal migration |
| [Content and Threat Intelligence](#content-and-threat-intelligence) | CI/CD pipelines, Content Hub lifecycle, TI activation |
| [Automation](#automation) | Automation rules vs playbooks, managed identity, Logic App tiers, Function Apps, testing |
...
| [Security Copilot Cross-Dependencies](#security-copilot-cross-dependencies-and-what-breaks-without-them) | Sentinel configurations that directly affect Copilot output quality |
