...
- [Capacity Reservations and Reserved Instances Are Not Mutually Exclusive](articles/cost-optimization/capacity-reservations-reserved-instances-savings-plans.md) — Capacity Reservations guarantee compute availability. Reserved Instances and Savings Plans reduce the rate. They solve different problems and stack intentionally.
